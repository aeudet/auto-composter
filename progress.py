...
home_time_signature = generate_time_signature
...
#home_key = check scale/mode to see if major or minor, then random.choice Major scale notes, or minor.

#Major_Scale_Notes = [A,A\#,B,C,C#,D,D#,E,E#,F,G,G#]
#Minor_Scale_Notes = [Ab,A,Bb,B,C,Dd,D,Eb,E,F,Gb,G]
...
# NEEDS TO DO A MODULATION CHECK
